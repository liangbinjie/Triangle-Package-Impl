...
public class LLVMGenerator implements Visitor {
    ...
    public void generateRun(Program theAST, String triangleSourceFileName) {
        ...
        String llvmCode = assembleLLVMOutput(triangleSourceFileName);
        
        String outputFilename = getOutputFilename(triangleSourceFileName);
    ...
    private String assembleLLVMOutput(String sourceFileName) {
        StringBuilder result = new StringBuilder();
        
        result.append("; LLVM IR generated by Triangle compiler\n");
        result.append("; Source: ").append(sourceFileName).append("\n\n");
        
        result.append("target triple = \"x86_64-pc-windows-msvc\"\n");
        result.append("target datalayout = \"e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128\"\n\n");
        
        if (usesPrintf || usesScanf || usesPutchar) {
            emitIODeclarations();
        }
        
        result.append(globals.toString());
        
        if (procedures.length() > 0) {
            result.append("\n; ==================== PROCEDURES ====================\n\n");
            result.append(procedures.toString());
        }
        
        result.append("\n; ==================== MAIN ====================\n\n");
        result.append(assembleMainFunction());
    ...
    private String assembleMainFunction() {
        StringBuilder main = new StringBuilder();
        
        main.append("define dso_local i32 @main() {\n");
        main.append("entry:\n");
        main.append(mainBody.toString());
    ...
    private String getOutputFilename(String sourceFileName) {
        if (sourceFileName.endsWith(".tri")) {
            return sourceFileName.replaceAll("\\.tri$", ".ll");
        }
        return sourceFileName + ".ll";
    }
